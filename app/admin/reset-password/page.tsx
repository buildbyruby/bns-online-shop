    ...
    <div className="flex min-h-screen items-center justify-center bg-black text-white px-5 py-10 sm:p-8">
      <div className="w-full max-w-sm space-y-8 sm:space-y-10">
        <div className="space-y-3">
          ...
          <p className="text-[10px] text-zinc-400">Enter your new admin account password below.</p>
        </div>
        {done ? (
          ...
          <div className="space-y-4">
            ...
            <p className="text-[9px] text-zinc-400">If this takes too long, the link may have expired. <button onClick={() => router.push("/admin/login")} className="text-white underline">Go back</button></p>
          </div>
        ) : (
