...
import { BadgeDollarSign, Eye, EyeOff } from "lucide-react";
...
export default function SalesResetPassword() {
  ...
  const handleReset = async (e: any) => {
    ...
    setDone(true);
    setTimeout(() => router.push("/sales/login"), 2000);
  };
      ...
      <div className="w-full max-w-sm space-y-8 sm:space-y-10">
        ...
        {done ? (
          ...
          <div className="space-y-4">
            ...
            <p className="text-[9px] text-zinc-400">Link expired? <button onClick={() => router.push("/sales/login")} className="text-white underline">Go back</button></p>
          </div>
        ) : (
